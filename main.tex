...
\vspace{1.75em}
We now elaborate on how we reach the conclusion stated in part~\ref{claim 2}, that taking $\ell$ to be $(t+1)C+k = tC+k(k-1)(k-2)$, the largest it can be in its interval, gives the best option in its interval. We consider each of the two subproblems.
